//Un alumno desea saber cual sera su promedio final en la materia 
//de algoritmos. Dicho promedio se compone de tres exámenes.
...
public class Ejercicio01 extends JFrame{
	...
	public static void main(String args[]){
		Ejercicio01 pro = new Ejercicio01();
		pro.setVisible(true);
		pro.setSize(450,400);
