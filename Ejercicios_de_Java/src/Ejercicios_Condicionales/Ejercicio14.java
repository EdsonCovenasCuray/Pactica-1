//Elabore un programa que lea tres (3) números enteros positivos y que muestre la suma y resta  
...
public class Ejercicio14 extends JFrame {
	...
	public Ejercicio14(){
		titulo= new JLabel("Suma y Resta de 3 numeros");
		...
		boton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int sr = valor1 + valor2 - valor3;
			if (valor1 > 0 && valor2 > 0){
				res.setText("LA SUMA ES: " + su + " ,LA RESTA : " + re+" , LA SUMA Y RESTA  : "+ sr);
			} else{
	...
	public static void main(String args[]){
		Ejercicio14 srs = new Ejercicio14();
		srs.setVisible(true);
		srs.setBounds(400,100,550,400);
